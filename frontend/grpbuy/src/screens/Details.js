...
export default function Details() {
    ...
    const getProduct = async () => {
        let response = await fetch(`http://127.0.0.1:4000/api/groups/groups/${groupId}`, {
            method: 'GET',
            headers: {
    ...
    const getBids = async () => {
        let response = await fetch(`http://127.0.0.1:4000/api/bids/bids/${groupId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('authToken')
    ...
    const applyToGroup = async () => {
        let response = await fetch(`http://127.0.0.1:4000/api/groups/groups/apply`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('authToken')
