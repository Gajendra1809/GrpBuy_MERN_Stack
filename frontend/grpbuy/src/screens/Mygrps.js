...
export default function Mygrps() {
    ...
    const getGroups = async () => {
        let response = await fetch('http://127.0.0.1:4000/api/groups/groups/applied', {
            method: 'GET',
            headers: {
    ...
    const cancelApplication = async (id) => {
        let response = await fetch(`http://127.0.0.1:4000/api/groups/groups/cancel`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('authToken')
    ...
    const cancelBid = async (id) => {
        let response = await fetch(`http://127.0.0.1:4000/api/bids/bids/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('authToken')
    ...
    const getBids = async () => {
        let response = await fetch('http://127.0.0.1:4000/api/bids/bids/applied', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage.getItem('authToken')
